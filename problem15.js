...
function paperRequirements(firstbook, secondbook, thirdbook) {
    var firstbookpaper = firstbook * 100;
    var secondbookpaper = secondbook * 200;
    var thirdbookpaper = thirdbook * 300;
    var totallPaper = firstbookpaper + secondbookpaper + thirdbookpaper;
    console.log("Your totll book page is" + '  ' + totallPaper);
}
